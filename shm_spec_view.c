...
int main(int argc, char **argv)
{
    ...
    float  *aspec_ptr            // Pointer to Auto-power Spectra
    // float  *xspec_ptr            // Pointer to Cross-power Spectra
    ...
    aspec_ptr = shmat(param_ptr->shrd_aspec_id, NULL, SHM_RDONLY);
    ...
    while(param_ptr->validity & ACTIVE){
        ...
        bunchVec(NST*NFFT2, bunchNum, aspec_ptr, spec_ptr);
